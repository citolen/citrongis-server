function main() {
	...
	//var profileManager = new (require("./manager/profileManager.js"))(app);
	...
	app.get("/profile/:cmd/name/:value?", function(req, res) {

		if (req.params["cmd"] && req.params["cmd"] == "get") 
		{
			res.send(user1.data.userInfo.firstName)
		}
		else if (req.params["cmd"] && req.params["cmd"] == "set") 
		{
			if (req.params["value"])
			{
				user1.data.userInfo.firstName = req.params["value"];
				user1.save(function() {
					res.send("OK");
				})
			}
