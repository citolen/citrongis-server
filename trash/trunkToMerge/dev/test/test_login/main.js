function main(app, route) {
    ...
    this.loginManager = new (require('./loginManager.js'))(app);
...
main.prototype.initRoute = function() {
	...
	var main = function (body , res) {
 		...
 		console.log(body);
 		var to_send = me.getStatusBox(accessToken) + me.getActionBox();
 		res.send(to_send);
 	}
	...
	me.app.post(me.route_subscribe_handle,  function (req, res) {
		me.loginManager.subscribe(req.body);
		res.redirect(me.route);
	});
...
main.prototype.getActionBox = function() {
	...
	'<a href="http://192.168.56.101:8080'+  this.route_secret + '">secret</a><br />' +
